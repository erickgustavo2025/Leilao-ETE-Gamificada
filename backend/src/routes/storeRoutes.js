...
router.post('/items', protect, admin, upload.single('imagem'), processImageToWebp, storeController.createItem);
router.put('/items/:id', protect, admin, upload.single('imagem'), processImageToWebp, validate(schemas.store.updateItem), storeController.updateItem);
