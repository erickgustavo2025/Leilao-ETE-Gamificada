    ...
    const filteredLogs = useMemo(() => {
        return logs.filter(log => {
            ...
            if (activeFilter === 'ECONOMY') {
                const moneyActions = ['ADMIN_GIVE_POINTS', 'ADMIN_REMOVE_POINTS', 'MANUAL_POINT_UPDATE', 'BID_PLACED', 'AUCTION_WIN', 'COMPRA_LOJA', 'BECO_COMPRA', 'PIX_SENT', 'PIX_RECEIVED', 'TRADE_COMPLETED'];
            ...
            if (activeFilter === 'MANAGEMENT') {
                const mngtActions = ['PROMOTE', 'DEMOTE', 'UPDATE_PROFILE', 'RESET_ACCESS', 'ADMIN_ACTION', 'GIFT_CREATE', 'AUCTION_CREATE', 'ITEM_CREATE', 'ITEM_UPDATE', 'ITEM_DELETE'];
            ...
            <PageTransition>
                <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="font-vt323 text-4xl text-green-400 uppercase">Auditoria Geral</h1>
                ...
                <div className="flex gap-2 overflow-x-auto pb-4 mb-4 scrollbar-hide">
                    ...
                    {isLoading ? (
                        ...
                        <div className="space-y-3 pb-20 overflow-y-auto pr-2 scrollbar-thin scrollbar-track-slate-900 scrollbar-thumb-slate-700">
